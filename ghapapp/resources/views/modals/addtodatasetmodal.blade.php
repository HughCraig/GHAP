<button type="button" class="mt-3 mb-3 btn btn-primary" data-toggle="modal" data-target="#addModal">Add to layer</button>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">Add to layer</h3>
			...
			<label for="addplacename">Placename</label><span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="right" 
			...
			<label for="addlatitude">Latitude</label><label class="text-danger">*</label><span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="right" 
 title="Try <a href='https://tlcmap.org/quicktools/quickcoordinates.html'>Quick Coordinates</a>."> 
                    ...
                    <div class="col-lg-6">
                        ...
                        $(function () {
                                $('#addDateStartDiv').datepicker({format: 'yyyy-mm-dd', todayBtn: true, forceParse: false, keyboardNavigation: false});
                                $('#addDateEndDiv').datepicker({format: 'yyyy-mm-dd', todayBtn: true, forceParse: false, keyboardNavigation: false});
                            });
                        </script>
