...
@section('content')
    ...
    <div class="content">
        ...
        <table class="table">
            ...
            <tr><td>Verified</td><td>@if(Auth::user()->email_verified_at !== null)<span class="text-success">Email has been verified</span> @else<span class="text-danger">Email has not been verified</span> @endif</td></tr>
