            ...
            <div class="row">
                <div class="col-lg p-5">
                    ...
                    *Description
                    ...
                    <textarea rows="3" maxlength="500" class="w-100 mb-2 w3-white form-control" name="description"
                              required></textarea>
                    ...
                    <textarea rows="3" maxlength="500" class="w-100 mb-2 w3-white form-control"
