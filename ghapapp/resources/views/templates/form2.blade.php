...
<label data-toggle="tooltip" title="Search ANPS aggregated gazetteer of 'official' place names.">Gazetteer <input type="checkbox" id="searc
hausgaz" name="searchausgaz" checked></label>
<br>
<label data-toggle="tooltip" title="Search layers from research and user community.">Layers <input type="checkbox" id="searchpublicdatasets
" name="searchpublicdatasets" checked>
...
<div class="row">
        ...
        <div class="col-xl-5 col-md-6 offset-xl-1 sub-filter-div">
            ...
            <h3>Search placenames by file</h3>
                <!-- help hover button -->
                <p>Select the file to upload <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placeme
nt="right"
...
<!-- ending filter accordion section -->
      </div>
    </div>
  </div>
