...
<label data-toggle="tooltip" title="Search ANPS aggregated gazetteer of 'official' place names.">Gazetteer <input type="checkbox" id="searchausgaz" name="searchausgaz" checked></label>

<label data-toggle="tooltip" title="Search layers from research and user community.">Layers <input type="checkbox" id="searchpublicdatasets" name="searchpublicdatasets" checked></label>
    ...
    <div class="d-flex justify-content-center w3-light-grey">
        ...
        <div class="row">
            <div class="col-sm-auto filter-div" style="max-width:500px; margin-bottom: 1em;">
                ...
                <p>Note: this may find some but not necessarily all as records may not be tagged comprehensively, and state records differ.</p>
                ...
                <div class="row align-items-center my-auto"><div class="col-sm-4"  data-toggle="tooltip" title="Not all places are tagged with their feature for all states, so this will return only partial results for some areas.">Feature:</div><div class="col-sm-8"><input type="text" class="w3-white form-control" name="feature_term" id="feature_term" autocomplete="off"></div></div>
				...
				<div class="row align-items-center my-auto"><div class="col-sm-4" data-toggle="tooltip" title="Download as a file instead of open in a browser window if you choose kml, csv or geojson.">
                    Download?</div><div class="col-sm-8"><input type="checkbox" id="download" name="download"></div></div>
        ...
        <div class="col-sm-auto ">
            <h3>Search for a list of place names</h3>
                <!-- help hover button -->
                <p>Select a file containing a list of place names to upload <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" 
                data-toggle="tooltip" data-placement="right" title="File must have placenames either one per line or seperated by commas.">
                            </span></p>
        ...
        NB: the popup content for this is below. It can't be here as it contains a form element, which would create bad form nesting. -->
            ...
            <button type="button" class="d-inline-block border border-dark" data-toggle="modal" data-target="#kmlPolygonSearchModal">Choose File</button>
                ...
                <select id="mapselector" class="h4 m-0 mt-2 mb-3 text-center">
                    ...
                    <div id="bboxdiv">
                        ...
                        <div class="rTableRow d-inline-flex" style="line-height:32px;">
                            <input type="text" class="w3-white form-control p-2" id="minlong" placeholder="min long"><p class="mr-2 ml-2 text-decoration-none">to</p>
                            <input type="text" class="w3-white form-control p-2" id="maxlong" placeholder="max long">
                        </div>

                        <p class="text-center mb-0">Latitude</p>
                        <div class="rTableRow d-inline-flex" style="line-height:32px;">
                            <input type="text" class="w3-white form-control p-2" id="minlat" placeholder="min lat"><p class="mr-2 ml-2 text-decoration-none">to</p>
                    ...
                    <div id="circlediv" class="hidden">
                        ...
                        <div class="rTableRow d-inline-flex" style="line-height:32px;">
                            Lng:<input type="text" class="w3-white form-control p-2 ml-2" id="circlelong" placeholder="longitude">
                            </div>
                        <div class="rTableRow d-inline-flex" style="line-height:32px;">
                            Lat:<input type="text" class="w3-white form-control p-2 ml-2" id="circlelat" placeholder="latitude">
                            </div>
                        <div class="rTableRow d-inline-flex" style="line-height:32px;">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="kmlPolygonSearchModalLabel">Search within a polygon using a KML file. Eg: you may have a KML file of an LGA suburb or national park.</h3>
