...
function continueSearchForm(names=null) {
  ...
  if (datefrom.value && !dateMatchesRegex(datefrom.value)) {datefrom.classList.add('is-invalid'); return alert('"Date From" field is NOT in a valid format!');}
  if (dateto.value && !dateMatchesRegex(dateto.value)) {dateto.classList.add('is-invalid'); return alert('"Date To" field is NOT in a valid format!');}
