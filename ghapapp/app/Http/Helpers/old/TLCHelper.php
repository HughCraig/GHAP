...
class TLCHelper 
{
    ...
    public static function toGeoJSON2 ($results, $sources) { //receives $results (an array of string lines) and $sources (an array of arrays of source information)
    ...
    public static function toGeoJSON ($results, $sources) { //receives $results (an array of string lines) and $sources (an array of arrays of source information)
