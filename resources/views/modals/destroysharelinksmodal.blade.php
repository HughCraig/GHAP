<button type="button" class="mt-3 mb-3 btn btn-primary" data-bs-toggle="modal" data-bs-target="#destroyLinksModal">Destroy Share Links</button>
<!-- MODAL popup -->
<div class="modal fade" id="destroyLinksModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" id="delete_share_links_button" data-bs-dismiss="modal">Yes, Destroy all share links</button>
