            ...
            <div class="modal-body scrollable">
                <div class="scrollable">
                    ...
                    <div class="mb-2" style="font-weight: bold;">
                        ...
                        <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="A place must be part of a 'Layer'. A Layer might be places about a certain topic, or simply 'My Places'. You must create a Layer to add places to it. You can change Layer details later after you create it. You will return to this screen after creating a new layer."></span>
                    ...
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="A short title for the information you are adding about this place."></span>
                    <input type="text" class="mb-3 form-control" id="addtitle" placeholder="Title" required>

                    <label for="addplacename">Placename</label>
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="Every item must have a Title and Placename is optional. If the purpose is to name a place, then put the Placename in the Title too.">
                    </span>
                    <input type="text" class="mb-3 form-control" id="addplacename" placeholder="Placename" required>

                    <!-- Image Upload -->
                    <label for="addImage">Image</label>
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title='Max upload size {{ floor(config("app.max_upload_image_size") / (1024 * 1024)) . " MB" }}'>
                    </span>
                    ...
                    <div class="map-picker">
                        ...
                        <label for="addlatitude">Latitude</label><label class="text-danger">*</label>
                            <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="Use decimal coordinates. For adding many places,try <a href='https://tlcmap.org/quicktools/quickcoordinates.html' target='_blank'>Quick Coordinates</a> and upload a CSV."></span>
                    ...
                    <label for="addfeatureterm">Feature Term
                        <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="A list of feature terms for types of places such as mountains, towns or rivers, used by government bodies. Start typing to see a list of terms."></span>
                    </label>
                    ...
                    <div class="input-group date" id="addDateStartDiv">
                        <label for="adddatestart">Date Start
                            <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="Type a year, date, or select from calendar"></span>
                        </label>
                    ...
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="Local Government Area"></span>               
                    ...
                    <label for="addexternalurl">Linkback (URL)
                        <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="This is the main link for more information on another website about this place. Eg: a newspaper article, record in a museum database, video of a story, organisations website, etc. It must start with http:// or https://"></span>
                    </label>
                    ...
                    <div class="mb-3">
                        <label for="addsource">Source (Website url, ISBN, Book title, etc)
                            <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right" title="Please add the citation or source of this information, to ensure it is reliable and so others can follow the references."></span>
                        </label>
