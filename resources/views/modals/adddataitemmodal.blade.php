            ...
            <div class="modal-body scrollable">
                <div class="scrollable">
                    ...
                    <div class="mb-2" style="font-weight: bold;">
                        ...
                        <button style="float: right;" onclick="window.open('{{ url('/myprofile/mydatasets/newdataset') }}', '_blank')">Edit layer</button>
                    </div>
                    ...
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="right" title="Every item must have a Title and Placename is optional. If the purpose is to name a place, then put the Placename in the Title too.">
                    </span>
