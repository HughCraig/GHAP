                ...
                <div class="modal-body scrollable">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="mb-4 w3-white form-control" name="dsn"
                                value="{{ $ds->name }}" required />
                            ...
                            <input id="tags" name="tags" type="text"
                                class="smallerinputs mb-4 w3-white form-control" />
                        ...
                        <div class="col-lg-6">
                            ...
                            <span tabindex="0" data-html="true" data-animation="true"
                                class="glyphicon glyphicon-question-sign" data-toggle="tooltip"
                                data-placement="right"
                                title="The URL linking to the source for the information in this layer. This should be the URL only.">
                            </span>
                            ...
                            <span tabindex="0" data-html="true" data-animation="true"
                                class="glyphicon glyphicon-question-sign" data-toggle="tooltip"
                                data-placement="right"
                                title="The URL linking to the website for your project. This should be the URL only.">
                            </span>
                            ...
                            <div class="border p-3 mb-4">
                                from latitude: <input type="text" class="mb-4 w3-white form-control"
                                    name="latitudefrom" value="{{ $ds->latitude_from }}" />
                                from longitude: <input type="text" class="mb-4 w3-white form-control"
                                    name="longitudefrom" value="{{ $ds->longitude_from }}" />
                                to latitude: <input type="text" class="mb-4 w3-white form-control"
                                    name="latitudeto" value="{{ $ds->latitude_to }}" />
                                to longitude: <input type="text" class="mb-4 w3-white form-control"
                                    name="longitudeto" value="{{ $ds->longitude_to }}" />
                            </div>
                            ...
                            <div class="border p-3 mb-4">
                                <div class="input-group date" id="temporalfromdiv">
                                    From: <input type="text" value="{{ $ds->temporal_from }}"
                                        class="mb-2 w3-white form-control input-group-addon" name="temporalfrom"
                                        id="temporalfrom" autocomplete="off" />
                                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-4">
                                ...
                                <textarea rows="3" maxlength="1500" class="w-100 mb-4 w3-white form-control wysiwyg-editor" name="description"
                                    id="description">{{ $ds->description }}</textarea>
                            </div>
                            <div class="mb-4">
                                Content Warning
                                <span tabindex="0" data-html="true" data-animation="true"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea rows="3" maxlength="1500" class="w-100 mb-4 w3-white form-control wysiwyg-editor" name="citation">{{ $ds->citation }}</textarea>
                            </div>
                            <div class="mb-4">
                                Usage Rights
                                <span tabindex="0" data-html="true" data-animation="true"
                                ...
                                <textarea rows="3" maxlength="1500" class="w-100 mb-4 w3-white form-control wysiwyg-editor" name="rights">{{ $ds->rights }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
