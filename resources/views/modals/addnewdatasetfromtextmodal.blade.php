            ...
            <div class="modal-body scrollable">
                ...
                <div class="scrollable">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea rows="3" maxlength="1500" class="w-100 mb-2 w3-white form-control wysiwyg-editor" id="description">{{$text->description}}</textarea>
                    </div>
                    ...
                    <input type="text" class="mb-2 w3-white form-control" id="creator" value="{{$text->creator}}" />

                    Publisher
                    <input type="text" class="mb-2 w3-white form-control" id="publisher" value="{{$text->publisher}}"/>

                    Contact
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right"
                        title="Contact details if people have questions about this layer."></span>
                    <input type="text" class="mb-2 w3-white form-control" id="contact" value="{{$text->contact}}" />
                    ...
                    <input type="text" class="mb-4 w3-white form-control" id="doi" value="{{$text->doi}}"/>
                    ...
                    <input type="text" class="mb-4 w3-white form-control" id="source_url" value="{{$text->source_url}}"/>

                    Linkback
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right"
                        title="The URL linking to the website for your project. This should be the URL only."> </span>
                    <input type="text" class="mb-4 w3-white form-control" id="linkback" value="{{$text->linkback}}"/>

                    Language
                    <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right"
                        title="The language this layer is in. Use the two-digit language code where possible, such as ‘EN’ for English."></span>
                    <input type="text" class=" mb-2 w3-white form-control" id="language" value="{{$text->language}}"/>
                    ...
                    <input type="text" class="mb-2 w3-white form-control" id="license" value="{{$text->license}}"/>
                    ...
                    <div class="border p-3 mb-3">
                        <div class="input-group date" id="temporalfromdiv">
                            From: <input type="text" value="{{$text->temporal_from}}" class="mb-2 w3-white form-control input-group-addon" id="temporalfrom" autocomplete="off" />
                        </div>
                        <div class="input-group date" id="temporaltodiv">
                            To: <input type="text" value="{{$text->temporal_to}}" class="mb-2 w3-white form-control input-group-addon"  id="temporalto" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <input type="date" class="mb-2 w3-white form-control" id="created" value="{{$text->created}}"/>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea rows="3" maxlength="1500" class="w-100 mb-2 w3-white form-control wysiwyg-editor" id="citation">{{ $text->citation }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea rows="3" maxlength="1500" class="w-100 mb-2 w3-white form-control wysiwyg-editor" id="warning">{{$text->warning}}</textarea>
                    </div>
                    <div class="mb-4">
                        Usage Rights
                        <span tabindex="0" data-html="true" data-animation="true" class="glyphicon glyphicon-question-sign" data-bs-toggle="tooltip" data-placement="right"
                        ...
                        <textarea rows="3" maxlength="1500" class="w-100 mb-2 w3-white form-control wysiwyg-editor" id="rights">{{ $text->rights }}</textarea>
                    </div>
