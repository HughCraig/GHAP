        ...
        <div class="modal-content">
            ...
            <form action="{{ url('bulkadddataitem') }}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div><label for="overwriteStyle">Append existing style data with the style data in this KML?</label>
                        <input type="checkbox" id="overwriteStyle" name="appendStyle" checked>
                    </div>
                    <div><label for="overwriteJourney">Overwrite existing journey (Track) data with the journey data in
                            this KML?</label> <input type="checkbox" id="overwriteJourney" name="overwriteJourney"
                            checked></div>
                    <p>For mobility dataset uploads only:</p>
                    <div><label for="uploadODPairs">Upload origin-destination pairs dataset?</label> <input
                            type="checkbox" id="uploadODPairs" name="uploadODPairs" unchecked></div>
                    <p>(If you're not sure what's origin-destination pairs, please check the explanation here.)</p>
                </div>
