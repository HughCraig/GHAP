...
@section('content')
    ...
    <p class="h4">See the <a href="https://www.tlcmap.org/guides/ghap/#contribute" target="_blank">Guide</a> for help and
        instructions on creating and adding to layers.</p>
                ...
                <div class="col-lg p-5">
                    <div class="mb-4">
                        *Description
                        ...
                        <textarea rows="3" maxlength="1500" class="w-100 mb-2 w3-white form-control wysiwyg-editor"
