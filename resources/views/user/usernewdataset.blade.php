...
@section('content')
    ...
    <!-- COLLAPSIBLE ON SMALL, ALWAYS SHOWN ON LG+ -->
    
      <div class="row">
        <div class="col-12 col-lg p-2">
        <button class="btn btn-outline-secondary w-100 text-start d-lg-none mb-2"
        type="button"
        data-bs-toggle="collapse"
        data-bs-target="#adv-col1"
        aria-expanded="false"
        aria-controls="adv-col1">
        Details
        </button>
        <h4 class="d-none d-lg-block">Details</h4>

        <div id="adv-col1" class="collapse d-lg-block">
            ...
            <div class="col-12 col-lg p-2">
                ...
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#adv-col2"
                aria-expanded="false"
                aria-controls="adv-col2">
                Licence and Permissions
                </button>
                <h4 class="d-none d-lg-block">Licence and Permissions</h4>

                <div id="adv-col2" class="collapse d-lg-block">
                ...
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#adv-col3"
                aria-expanded="false"
                aria-controls="adv-col3">
                Region and Dates
                </button>
                <h4 class="d-none d-lg-block">Region and Date Range</h4>

                <div id="adv-col3" class="collapse d-lg-block">
            ...
            <button class="m-1 p-2 btn btn-primary" type="Submit" id="addDatasetSaveButton">Create Layer</button>
        </form>
    </div>
