        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="visualiseDropdown">
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-3d.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json'))">3D
                    Viewer</a>
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-cluster.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json'))">Cluster</a>
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-journey.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json?line=route'))">Journey
                    Route</a>
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-journey.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json?line=time'))">Journey
                    Times</a>
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-timeline.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json?sort=start'))">Timeline</a>
                <a class="dropdown-item grab-hover"
                    onclick="window.open('{{ config('app.views_root_url') }}/collection-werekata.html?load=' + encodeURIComponent('{{ url('multilayers') }}/{{ $collection->id }}/json'))">Werekata
                    Flight by Route</a>
                <a class="dropdown-item grab-hover"
            ...
            <tbody>
                ...
                @foreach ($collection->savedSearches as $ss)
                    <tr id="row_ss_id_{{ $ss->id }}">
                        ...
                        <td>
                            <button name="remove_savedsearch_button" data-collection-id="{{ $collection->id }}"
                                id="remove_savedsearch_button_{{ $ss->id }}" type="Button">Remove</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
